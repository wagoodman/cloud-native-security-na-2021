...
export ORIGINAL_IMAGE_TAG=localhost/whiteout-content:original-by-modification
export IMAGE_DIR=./image
export PAYLOAD_FILE=./payload.txt
export FINAL_IMAGE_TAR=./image-modified.tar
export FINAL_IMAGE_TAG=localhost/whiteout-content:modified-by-modification
